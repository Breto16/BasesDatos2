<%-- 
    Document   : main
    Created on : 20 sept 2023, 12:54:51
    Author     : Isaac Brenes
--%>
...
<body>
    <div id="HeaderBar">
        <h1>Cadenas Gyms</h1>
        <a href="login.jsp" class="custom-buttonR"><span class="material-symbols-outlined">logout</span></a>
    </div>
    
    <div class="container">
        <div class="left">
            <a href="index.jsp" class="custom-button"><span class="material-symbols-outlined">home</span></a>
            <br />
        ...
        <div class="right">
            ...
            <h1>Menú Inicial</h1>
            <br />
            <h2>Ejemplos Controles</h2>
            <br />
            <form action="main.jsp" method="post"> 
                <div class="form-control">
                    <input type="text" name="txt_email" class="form-control" placeholder="Texto Normal" />
                </div>
                <div class="form-control">
                    <input type="password" name="txt_pass" class="form-control" placeholder="Texto Contraseñas" />
                </div>
                <div>
                    <span class="error">
                ...
                <div class="button-container">
                    <input type="submit" name="btn_Login" class="gradient-button" value="Botones" />
